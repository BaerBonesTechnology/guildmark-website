...
const PLACEHOLDER_CHART_DATA: { month: string; current: number; upgrade: number }[] = [];

// TODO: Replace with data from GET /dashboard → high_demand_assets once
// the backend demand-signal query is implemented.
const PLACEHOLDER_HIGH_INTENT: { tag: string; specs: string; demand: number; peakDate: string; status: string }[] = [];
