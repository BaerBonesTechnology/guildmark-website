/// Data-access for partners + partner refresh tokens.
library;
...
class PartnerRepo {
  ...
  /// Atomically validate + rotate a partner refresh token. Returns the partner
  /// the token belongs to, or null if the token is invalid/expired/revoked.
